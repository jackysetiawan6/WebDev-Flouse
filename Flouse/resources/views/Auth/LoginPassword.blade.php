...
<body>
    <div class="container">
        ...
        <form class="form" method="POST" action="/login/password">
            @csrf
            <div class="main-form">
                <h1 class="welcome-text">Enter your password</h1>
                <div class="input-text">
                    {{-- <input required type="text" name="email" class="input-text email"> --}}
                    <p>{{ $email }}</p>
                    <a href="/login" class="linked-text">Edit</a>
                </div>
                <div class="input-box pass">
                    <input required name="password" type="password" class="input-text password" id="pass-text">
                ...
                <div class="text-under">
                    <div class="remember-me">
                        <input type="checkbox" name="checkbox" class="checkbox-agree">
