        ...
        <form class="form" action="/register" method="post">
            ...
            <div class="main-form">
                ...
                <div class="input-box name">
                    <input required name='name' type="text" class="input-text name" value="{{ old('name') }}">
                    <label class="input-label name">Full Name</label>
                    @error('name')
                    <div>
                        <p class="error-msg" id="fullname-error">{{ $message }}</p>
                    </div>
                    @enderror
                </div>
                <div class="input-box email">
                    <input name='email' required type="text" class="input-text email" id="email-text" value="{{ old('email') }}">
                    <label class="input-label email">Email</label>
                    @error('email')
                    <div>
                        <p class="error-msg" id="email-error">{{ $message }}</p>
                    </div>
                    @enderror
                </div>
                <div class="input-box outer">
                    <div class="input-box pass">
                        <input name='password' required type="password" class="input-text pass" id="pass-text">
                    ...
                    @error('password')
                    <div>
                        <p class="error-msg" id="pass-error">{{ $message }}</p>
                    </div>
                    @enderror
                </div>
                <div class="input-box re-pass">
                    <input name='reenterpass' required type="password" class="input-text re-pass" id="re-pass-text">
            ...
            <div class="submit">
                <button type="submit" class="submit-button" id="submit-btn">Explore Now</button>
            </div>
