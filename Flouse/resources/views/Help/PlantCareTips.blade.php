    ...
    <div class="page">
        ...
        <div class="right">
            ...
            <div class="sub1">
                ...
                <div class="sub2">
                    <ul class="point">
                        <li>Average Room Temperature: Most houseplants thrive in average room temperatures between 65°F and 75°F (18°C and 24°C). Avoid placing them near drafts or vents with extreme temperature fluctuations.</li>
                    </ul>
                </div>
            </div>
